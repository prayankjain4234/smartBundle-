...
import { Subject, BehaviorSubject, of, combineLatest, Observable, isObservable, ReplaySubject } from 'rxjs';
...
let ClrDatagrid = class ClrDatagrid {
    constructor(organizer, items, expandableRows, selection, rowActionService, stateProvider, displayMode, renderer, el, page, commonStrings) {
        ...
        this.clrDgSingleSelectionAriaLabel = this.commonStrings.singleSelectionAriaLabel;
        this.clrDgSingleActionableAriaLabel = this.commonStrings.singleActionableAriaLabel;
