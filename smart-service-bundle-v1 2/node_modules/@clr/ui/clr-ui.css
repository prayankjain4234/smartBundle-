...
.alert .dropdown-toggle.btn:active {
  -webkit-box-shadow: 0 1px 0 0 #4d007a inset;
  box-shadow: 0 1px 0 0 #4d007a inset;
}
...
.card {
  -webkit-box-shadow: 0 0.125rem 0 0 #d7d7d7;
...
.dropdown-menu {
  ...
  border: 1px solid #ccc;
  border-radius: 0.125rem;
  -webkit-box-shadow: 0 1px 0.125rem rgba(115, 115, 115, 0.25);
...
a.label.clickable:active {
  -webkit-box-shadow: 0 1px 0 0 #737373 inset;
  box-shadow: 0 1px 0 0 #737373 inset;
...
a.label.clickable.label-purple:active {
  -webkit-box-shadow: 0 1px 0 0 #9b56bb inset;
  box-shadow: 0 1px 0 0 #9b56bb inset;
  -webkit-transform: translateY(0.5px);
  transform: translateY(0.5px);
}
...
a.label.clickable.label-blue:active {
  -webkit-box-shadow: 0 1px 0 0 #004d8a inset;
  box-shadow: 0 1px 0 0 #004d8a inset;
  -webkit-transform: translateY(0.5px);
  transform: translateY(0.5px);
}
...
a.label.clickable.label-orange:active {
  -webkit-box-shadow: 0 1px 0 0 #fac400 inset;
  box-shadow: 0 1px 0 0 #fac400 inset;
  -webkit-transform: translateY(0.5px);
  transform: translateY(0.5px);
}
...
.nav .nav-link:hover, .nav .nav-link.active {
  -webkit-box-shadow: 0 -3px 0 #0079b8 inset;
...
.tooltip .tooltip-content.tooltip-top-right::before {
  ...
  border-top: 0.208333rem solid #000;
...
.tooltip .tooltip-content.tooltip-bottom-right::before {
  ...
  content: "";
  border-left: 0.25rem solid #000;
  border-bottom: 0.208333rem solid #000;
  border-right: 0.25rem solid transparent;
...
.tooltip .tooltip-content.tooltip-right::before {
  ...
  border-right: 0.208333rem solid #000;
...
.tooltip .tooltip-content.tooltip-left::before {
  ...
  content: "";
  border-top: 0.25rem solid #000;
  border-left: 0.208333rem solid #000;
  border-bottom: 0.25rem solid transparent;
...
.clr-checkbox-wrapper input[type=checkbox] + label::after {
  ...
  width: 0.3333335rem;
  border-left: 0.083333375rem solid #fff;
  border-bottom: 0.083333375rem solid #fff;
  top: 0.1666665rem;
  left: 0.16666675rem;
...
.clr-input:not([readonly]) {
  background: -webkit-gradient(linear, left top, left bottom, color-stop(95%, transparent), color-stop(95%, #0095d3)) no-repeat;
...
.clr-error .clr-input:not([readonly]) {
  ...
  background: -webkit-gradient(linear, left top, left bottom, color-stop(95%, transparent), color-stop(95%, #c92100)) no-repeat;
...
.clr-radio-wrapper input[type=radio]:checked + label::before {
  -webkit-box-shadow: inset 0 0 0 0.25rem #0079b8;
  box-shadow: inset 0 0 0 0.25rem #0079b8;
  border: none;
}
...
.clr-radio-wrapper input[type=radio]:focus:checked + label::before {
  outline: 0;
  -webkit-box-shadow: inset 0 0 0 0.25rem #0079b8, 0 0 2px 2px #6bc1e3;
  box-shadow: inset 0 0 0 0.25rem #0079b8, 0 0 2px 2px #6bc1e3;
}
...
.clr-error .clr-textarea:focus {
  outline: 0;
  -webkit-box-shadow: 0 0 2px 2px #ff7d63;
  box-shadow: 0 0 2px 2px #ff7d63;
}
...
.stack-view .stack-block-expandable > .stack-block-label::before {
  background-image: url("data:image/svg+xml;charset=utf8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2012%2012%22%3E%0A%20%20%20%20%3Cdefs%3E%0A%20%20%20%20%20%20%20%20%3Cstyle%3E.cls-1%7Bfill%3A%23565656%3B%7D%3C%2Fstyle%3E%0A%20%20%20%20%3C%2Fdefs%3E%0A%20%20%20%20%3Ctitle%3ECaret%3C%2Ftitle%3E%0A%20%20%20%20%3Cpath%20class%3D%22cls-1%22%20d%3D%22M6%2C9L1.2%2C4.2a0.68%2C0.68%2C0%2C0%2C1%2C1-1L6%2C7.08%2C9.84%2C3.24a0.68%2C0.68%2C0%2C1%2C1%2C1%2C1Z%22%2F%3E%0A%3C%2Fsvg%3E%0A");
  background-repeat: no-repeat;
  background-size: contain;
  vertical-align: middle;
  -webkit-transform: rotate(-90deg);
...
.datagrid-row .datagrid-action-overflow::after {
  ...
  border-right: 0.2083333333rem solid #fff;
...
.pagination-list .pagination-current:focus, .pagination-list .pagination-current.clr-focus {
  background: none;
  border: 1px solid #46afd9;
  -webkit-box-shadow: 0 0 1px #46afd9;
...
.tabs-vertical > .nav .nav-link.active, .tabs-vertical > .nav .nav-link:hover {
  -webkit-box-shadow: inset 3px 0 0 #0079b8;
  box-shadow: inset 3px 0 0 #0079b8;
}
...
.clr-wizard .clr-wizard-stepnav-item {
  display: block;
  -webkit-box-shadow: 0.166667rem 0 0 #eee inset;
  box-shadow: 0.166667rem 0 0 #eee inset;
  margin: 0 0 -1px 0;
  padding: 0.25rem 0;
...
.clr-accordion-header {
  color: #565656;
  border: 1px solid #ccc;
  -webkit-box-shadow: inset 6px 0 0 #eee;
  box-shadow: inset 6px 0 0 #eee;
  background: #fafafa;
